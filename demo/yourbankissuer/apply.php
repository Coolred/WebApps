<?php
setcookie('customappkey', 'WaeQ08x0LrhzvGJdPZcBK67LdJH6aKVOjICpReGz', time() + (365 * 24 * 60 * 60), '/');
setcookie('customappsecret', '3kREFUqcMoaJWVLmbi9OTR8tZpGSlGt457aFCWXt', time() + (365 * 24 * 60 * 60), '/');
